            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='wupinguashi'">
                    <el-form-item class="input" v-if="type!='info'"  label="物品类型" prop="shiwuzhaolingValue">
                        <el-input v-model="wupinguashiForm.shiwuzhaolingValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='wupinguashi'">
                    <el-form-item class="input" v-if="type!='info'"  label="物品状态" prop="statusValue">
                        <el-input v-model="wupinguashiForm.statusValue"
                ...
                <el-col :span="24" v-if="sessionTable !='wupinguashi'">
                    <el-form-item class="upload" v-if="type!='info' && !ro.wupinguashiPhoto" label="物品图片" prop="wupinguashiPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (wupinguashiForm.wupinguashiPhoto || '').split(',')" :src="item" width="100" height="100">
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='wupinguashi'">
                    <el-form-item class="input" v-if="type!='info'"  label="丢失时间" prop="wupinguashiTime">
                        <el-input v-model="wupinguashiForm.wupinguashiTime"
                                  placeholder="丢失时间" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="丢失时间" prop="wupinguashiTime">
                            <el-input v-model="ruleForm.wupinguashiTime"
                ...
                <el-col :span="12"  v-if="sessionTable !='wupinguashi'">
                    <el-form-item class="input" v-if="type!='info'"  label="丢失地址" prop="wupinguashiDizhi">
                        <el-input v-model="wupinguashiForm.wupinguashiDizhi"
...
<script>
    ...
    export default {
        ...
        created() {
            //当前text不能修改
            this.ro.wupinguashiLiuyanText = true;
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='wupinguashiId'){
                          this.ruleForm.wupinguashiId = obj[o];
                          this.ro.wupinguashiId = true;
                          continue;
                      }
                      if(o=='yonghuId'){
                      ...
                      if(o=='wupinguashiLiuyanText'){
                          this.ruleForm.wupinguashiLiuyanText = obj[o];
                          this.ro.wupinguashiLiuyanText = true;
                          continue;
                      }
                      if(o=='replyText'){
            ...
            info(id) {
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        this.wupinguashiChange(data.data.wupinguashiId)
